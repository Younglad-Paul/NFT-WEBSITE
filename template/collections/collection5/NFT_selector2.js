...
function ez() {
    ...
    $('#spn').html('Tourism #5')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TOURISM/white bunny 5.jpg'>"
}
function fz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Tourism #6')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TOURISM/white bunny 6.jpg'>"
}
function gz() {
    $('#nfts').css('display', 'none')
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Tourism #7')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TOURISM/white bunny 7.jpg'>"
}
function hz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Tourism #8')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TOURISM/white bunny 8.jpg'>"
}
