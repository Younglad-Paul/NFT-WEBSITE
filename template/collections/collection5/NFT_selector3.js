...
function yz() {
    ...
    $('#spn').html('Tourism #9')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TOURISM/white bunny 9.jpg'>"
}
function jz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Tourism #10')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TOURISM/white bunny 10.jpg'>"
}
