...
function az() {
    ...
    $('#spn').html('Award #1')
    img.innerHTML= "<img src='../assets/images/acom nft/TEAM AWARDS/black bunny 1.jpg'>"
}
function bz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Award #2')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM AWARDS/black bunny 2.jpg'>"
}
function cz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Award #3')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM AWARDS/black bunny 3.jpg'>"
}
function dz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Award #4')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM AWARDS/black bunny 4.jpg'>"
}
