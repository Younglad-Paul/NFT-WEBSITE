...
function ez() {
    ...
    $('#spn').html('Pageant #5')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM PAGEANT/rainbow bunny 5.jpg'>"
}
function fz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Pageant #6')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM PAGEANT/rainbow bunny 6.jpg'>"
}
function gz() {
    $('#nfts').css('display', 'none')
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Pageant #7')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM PAGEANT/rainbow bunny 7.jpg'>"
}
function hz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Pageant #8')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM PAGEANT/rainbow bunny 8.jpg'>"
}
