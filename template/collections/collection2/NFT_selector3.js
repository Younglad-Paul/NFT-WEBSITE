...
function yz() {
    ...
    $('#spn').html('Pageant #9')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM PAGEANT/rainbow bunny 9.jpg'>"
}
function jz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Pageant #10')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM PAGEANT/rainbow bunny 10.jpg'>"
}
