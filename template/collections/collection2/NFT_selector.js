...
function az() {
    ...
    $('#spn').html('Pageant #1')
    img.innerHTML= "<img src='../assets/images/acom nft/TEAM PAGEANT/rainbow bunny 1.jpg'>"
}
function bz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Pageant #2')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM PAGEANT/rainbow bunny 2.jpg'>"
}
function cz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Pageant #3')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM PAGEANT/rainbow bunny 3.jpg'>"
}
function dz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Pageant #4')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM PAGEANT/rainbow bunny 4.jpg'>"
}
