...
function ez() {
    ...
    $('#spn').html('Festival #5')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM FESTIVAL/striped bunny 5.jpg'>"
}
function fz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Festival #6')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM FESTIVAL/striped bunny 6.jpg'>"
}
function gz() {
    $('#nfts').css('display', 'none')
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Festival #7')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM FESTIVAL/striped bunny 7.jpg'>"
}
function hz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Festival #8')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM FESTIVAL/acom bunny jyh.png'>"
}
