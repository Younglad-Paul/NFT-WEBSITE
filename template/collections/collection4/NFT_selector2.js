...
function ez() {
    ...
    $('#spn').html('Talent #5')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TALENT/rand bunny 5.jpg'>"
}
function fz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Talent #6')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TALENT/rand bunny 6.jpg'>"
}
function gz() {
    $('#nfts').css('display', 'none')
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Talent #7')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TALENT/rand bunny 7.jpg'>"
}
function hz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Talent #8')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TALENT/rand bunny 8.jpg'>"
}
