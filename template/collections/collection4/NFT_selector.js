...
function az() {
    ...
    $('#spn').html('Talent #1')
    img.innerHTML= "<img src='../assets/images/acom nft/TEAM TALENT/rand bunny 1.jpg'>"
}
function bz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Talent #2')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TALENT/rand bunny 2.jpg'>"
}
function cz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Talent #3')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TALENT/rand bunny 3.jpg'>"
}
function dz() {
    $('#nfts').css('display', 'none')
    $('#purchase').css('display', 'block')
    $('#spn').html('Talent #4')
    img.innerHTML = "<img src='../assets/images/acom nft/TEAM TALENT/rand bunny 4.jpg'>"
}
